...
const About: React.FC = () => {
  ...
  return (
    <section id="about" className="relative py-20 lg:py-32 overflow-hidden bg-gradient-to-br from-slate-900 via-primary-900 to-slate-900">
      {/* Animated gradient orbs */}
      <div
        className="absolute top-1/4 left-0 w-[500px] h-[500px] bg-primary-500/20 rounded-full blur-[120px] animate-pulse"
        style={{
