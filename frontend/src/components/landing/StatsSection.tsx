      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            ...
            <span className="bg-gradient-to-r from-primary-400 to-primary-500 bg-clip-text text-transparent"> {t('landing.stats.titleHighlight')} </span>
          </h2>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {stats.map((stat, index) => (
            ...
            >
              <div className="bg-gray-900/50 backdrop-blur-xl rounded-2xl p-6 border border-gray-800 hover:border-primary-500/50 transition-all duration-300 hover:bg-gray-800/50">
        ...
        >
          {features.map((feature, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: index * 0.1 }}
              className="flex items-center gap-2 px-5 py-3 rounded-full bg-gray-900/50 border border-gray-800 hover:border-primary-500/50 transition-colors"
            >
