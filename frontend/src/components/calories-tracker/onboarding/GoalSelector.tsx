    ...
    <div className="space-y-6">
              ...
              <div className="flex items-center gap-3">
                <div className={`p-3 rounded-lg ${
                  ...
                  <Icon
                    path={goal.icon}
                    size={1.2}
                    className={selectedGoal === goal.id ? 'text-primary-300' : goal.iconColor}
                  />
                </div>
                <h3 className={`text-lg font-semibold ${selectedGoal === goal.id ? 'text-primary-300' : 'text-white'}`}>
                  {goal.title}
                </h3>
              </div>
      ...
      <div className="bg-primary-500/10 p-4 rounded-lg border border-primary-500/20">
        <p className="text-sm text-white/80">
          <strong className="text-primary-400">Tip:</strong> You can always change your goal later in your profile settings.
