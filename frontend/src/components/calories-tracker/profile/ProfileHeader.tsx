    ...
    <Card className="p-6 bg-white/5 border border-white/10">
      <div className="flex items-center gap-6">
        <div className="relative">
          <div className="w-24 h-24 rounded-full bg-gradient-to-br from-primary-500/20 to-primary-500/20 border-2 border-primary-400/30 flex items-center justify-center overflow-hidden">
            {photo ? (
          ...
          <label htmlFor="photo-upload" className="absolute bottom-0 right-0 p-1.5 bg-gradient-to-r from-primary-500 to-primary-600 rounded-full cursor-pointer hover:from-primary-600 hover:to-primary-700 transition-colors">
