          ...
          {result && (
            <div className="space-y-4">
              ...
              <div className={`p-6 rounded-lg border-l-4 border-[#6096B4] ${
                theme === 'dark' ? 'bg-gray-700' : t('tools.titheCalculator.bg0d948810', 'bg-[#6096B4]/10')
              }`}>
              ...
              <div className={`p-4 rounded-lg ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-100'}`}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className={`font-semibold ${titheBase === 'gross' ? 'text-[#6096B4]' : theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
                  ...
                  {result.netIncome !== result.grossIncome && (
                    <>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className={`font-semibold ${titheBase === 'net' ? 'text-[#6096B4]' : theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>
