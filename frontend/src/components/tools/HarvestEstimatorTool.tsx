          ...
          <div className={`p-4 rounded-lg ${isDark ? 'bg-gray-800' : 'bg-gray-50'}`}>
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="text-center p-3 rounded-lg bg-primary-500/10 ring-2 ring-primary-500">
                  <div className="text-3xl font-bold text-primary-500">{calculations.expectedYield}</div>
            ...
            <div className={`p-4 rounded-lg mb-4 ${isDark ? 'bg-gray-700' : 'bg-white'}`}>
              ...
              <div className="grid grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className={`font-bold text-primary-500`}>{calculations.harvestStart}</div>
                </div>
                <div>
              ...
              <div className="mt-3 h-2 bg-gray-600 rounded-full overflow-hidden">
                <div className="h-full bg-gradient-to-r from-primary-500 to-green-500" style={{ width: `${(calculations.harvestDuration / 90) * 100}%` }}></div>
              </div>
