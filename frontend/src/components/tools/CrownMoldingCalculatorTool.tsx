    ...
    <div className={`${isDark ? 'bg-gray-900 border-gray-700' : 'bg-white border-gray-200'} rounded-xl shadow-sm border overflow-hidden`}>
      ...
      {isPrefilled && (
        <div className="mx-6 mt-4 flex items-center gap-2 px-4 py-2 bg-[#6096B4]/10 rounded-xl border border-[#6096B4]/20">
          ...
          <span className="text-sm text-[#6096B4] font-medium">{t('tools.crownMoldingCalculator.settingsLoadedFromYourConversation', 'Settings loaded from your conversation')}</span>
        </div>
      )}
