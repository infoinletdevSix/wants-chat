    ...
    <div className={`${isDark ? 'bg-gray-900 border-gray-700' : 'bg-white border-gray-200'} rounded-xl shadow-sm border overflow-hidden`}>
      <div className={`${isDark ? 'bg-gradient-to-r from-gray-800 to-primary-900/20' : 'bg-gradient-to-r from-white to-primary-50'} px-6 py-4 border-b ${isDark ? 'border-gray-700' : 'border-gray-100'}`}>
        <div className="flex items-center gap-3">
          <div className="p-2 bg-primary-500/10 rounded-lg"><FileText className="w-5 h-5 text-primary-500" /></div>
          <div>
      ...
      <div className="p-6 space-y-6">
        {isPrefilled && (
          <div className="flex items-center gap-2 px-4 py-2 bg-primary-500/10 rounded-xl border border-primary-500/20">
            ...
            <span className="text-sm text-primary-500 font-medium">{t('tools.carLease.valuesLoadedFromAiResponse', 'Values loaded from AI response')}</span>
          </div>
        )}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className={`p-4 rounded-lg ${isDark ? 'bg-gray-800' : 'bg-gray-50'}`}>
            ...
            <div className="text-2xl font-bold text-primary-500">{formatCurrency(calculations.dueAtSigning)}</div>
        ...
        <div className={`p-4 rounded-lg ${isDark ? 'bg-gray-800' : 'bg-gray-50'}`}>
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className={`flex justify-between pt-2 border-t font-medium ${isDark ? 'border-gray-700 text-primary-400' : 'border-gray-200 text-primary-600'}`}>
