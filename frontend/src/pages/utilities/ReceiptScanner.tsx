              ...
              <div className="space-y-6">
                ...
                <Card className="bg-slate-800/50 border-primary-500/30 backdrop-blur-xl">
                  ...
                  <CardContent className="space-y-4">
                    <div className="bg-gradient-to-br from-primary-900/30 to-primary-900/30 rounded-2xl p-8 border-2 border-dashed border-primary-500/30 text-center">
                    ...
                    >
                      <Card className="bg-slate-800/50 border-primary-500/30 backdrop-blur-xl">
                        ...
                        <CardContent className="space-y-6">
                          ...
                          {/* Total */}
                          <div className="bg-gradient-to-r from-primary-500/20 to-primary-500/20 rounded-lg p-4 border border-primary-400">
                            <div className="flex items-center justify-between">
                          ...
                          <div className="flex gap-3">
                            <Button className="flex-1 bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white">
