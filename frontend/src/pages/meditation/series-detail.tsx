    ...
    return (
      <div className="space-y-6">
        <div className="text-center py-12">
          ...
          <Button onClick={() => navigate('/meditation/series')} className="bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white">Back to Series</Button>
        </div>
      </div>
    );
  }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                {isStarted && <Badge className="bg-gradient-to-r from-primary-500 to-primary-600 text-white">In Progress</Badge>}
              </div>
        ...
        <Card className="p-6 bg-white/10 backdrop-blur-xl border border-white/20">
          ...
          <div className="space-y-4">
            <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary-500/20 to-primary-500/30 flex items-center justify-center">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      {isCurrent && (
                        <Badge className="bg-gradient-to-r from-primary-500 to-primary-600 text-white text-xs">Up Next</Badge>
                      )}
                      {isCompleted && (
                  ...
                  <div className="flex-shrink-0">
                    {!isLocked && (
                      <Button
                        ...
                        size="sm"
                        className={isCurrent ? 'bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 text-white' : 'text-white hover:bg-white/10'}
                        onClick={(e) => {
                          e.stopPropagation();
