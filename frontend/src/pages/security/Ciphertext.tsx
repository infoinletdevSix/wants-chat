    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 max-w-6xl">
        ...
        <motion.div
          ...
          className="mb-6"
        >
          <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl border border-primary-400/30 p-2 inline-flex gap-2">
            <button
          ...
          >
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-slate-700/50 border border-slate-600 rounded-lg px-4 py-3 text-white placeholder-slate-400 focus:border-primary-500 focus:outline-none"
              />
        ...
        >
          ...
          <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl border border-primary-400/30 p-6">
            ...
            <textarea
              ...
              className="w-full h-64 bg-slate-900/50 border border-slate-700 rounded-lg px-4 py-3 text-white placeholder-slate-500 focus:border-primary-500 focus:outline-none resize-none font-mono"
            />
          </div>
