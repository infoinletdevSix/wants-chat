    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-primary-900 to-primary-900">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 pt-24">
        ...
        <div className="mb-8">
          ...
          <p className="text-primary-300">Organize and view your photo collection</p>
        </div>
        ...
        <div className="mb-6 flex flex-col md:flex-row gap-4">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-6 py-3 bg-white/10 backdrop-blur-lg border border-primary-500/30 text-white rounded-2xl hover:bg-white/20 transition flex items-center gap-2"
            >
              <FolderPlus size={20} />
              New Folder
            </button>
            <button
              ...
              className="p-3 bg-white/10 backdrop-blur-lg border border-primary-500/30 text-white rounded-2xl hover:bg-white/20 transition"
            >
                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 rounded-xl transition ${
                      selectedFolder === folder.name
                        ? 'bg-gradient-to-r from-primary-500/30 to-primary-500/30 border border-primary-400 text-white'
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
                      <div className="absolute bottom-0 left-0 right-0 p-4">
                        ...
                        <p className="text-primary-300 text-sm">{photo.size} • {photo.date}</p>
                      </div>
      ...
      {selectedPhoto && (
        <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4">
          ...
          <div className="max-w-6xl w-full">
            ...
            />
            <div className="mt-4 bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-primary-500/30">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-2xl font-bold text-white mb-2">{selectedPhoto.name}</h3>
                  <p className="text-primary-300">{selectedPhoto.size} • {selectedPhoto.date} • {selectedPhoto.folder}</p>
                </div>
                <div className="flex gap-3">
                  <button
      ...
      {showNewFolderDialog && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-3xl p-8 max-w-md w-full border border-primary-500/30">
            ...
            <input
              ...
              className="w-full bg-white/10 border border-primary-500/30 rounded-2xl py-3 px-4 text-white placeholder-primary-300/50 focus:outline-none focus:ring-2 focus:ring-primary-400 mb-6"
            />
            <div className="flex gap-3">
              <button
                onClick={() => setShowNewFolderDialog(false)}
                className="flex-1 px-6 py-3 bg-white/10 border border-primary-500/30 text-white rounded-2xl hover:bg-white/20 transition"
              >
                Cancel
              </button>
              <button
                onClick={createFolder}
                className="flex-1 px-6 py-3 bg-gradient-to-r from-primary-500 to-primary-600 text-white rounded-2xl hover:from-primary-600 hover:to-primary-700 transition"
              >
                Create
              </button>
            </div>
