          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <div className="relative w-80 h-48 mb-6">
              ...
              <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-6 text-center">
                ...
                <div className="text-primary-200 text-sm">lux</div>
              </div>
            </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-primary-400/20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
              <div className="flex justify-between items-center">
                <span className="text-primary-200">Moonless night:</span>
                <span className="text-white font-mono">0.001 lux</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-primary-200">Full moon:</span>
                <span className="text-white font-mono">0.1 lux</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-primary-200">Dark room:</span>
                <span className="text-white font-mono">10 lux</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-primary-200">Living room:</span>
                <span className="text-white font-mono">50 lux</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-primary-200">Office:</span>
                <span className="text-white font-mono">320-500 lux</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-primary-200">Overcast day:</span>
                <span className="text-white font-mono">1,000 lux</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-primary-200">Sunny day:</span>
                <span className="text-white font-mono">10,000 lux</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-primary-200">Direct sunlight:</span>
